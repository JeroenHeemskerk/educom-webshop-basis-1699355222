        ...
        <form action="contact.php" method="post">
            <div class="invoervelden">
                <label for="aanhef">Aanhef:</label>
                    <select class="sel" id="aanhef" name="aanhef">
                ...
                <label for="tel">Telefoonnummer:</label>
                    <input class="sw" type="text" id="tel" name="telnumber" placeholder="Typ hier uw telefoonnummer"><br>
                ...
                <label for="wp">Woonplaats</label>
                    <input class="sw" type="text" id="wp" name="woonplaats" placeholder="Typ hier uw woonplaats"><br>
                <br>   
            </div>
            <div>
            Kies uw communicatievoorkeur:<br>
                ...
                <input type="radio" id="tel" name="communicatievoorkeur" value="Telefoon">
